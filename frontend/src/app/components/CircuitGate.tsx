...
const gateStyles: Record<string, string> = {
  ...
  I: "bg-zinc-500/10 border-zinc-500/40 text-zinc-700",
  S: "bg-amber-500/10 border-amber-500/40 text-amber-700",
  T: "bg-orange-500/10 border-orange-500/40 text-orange-700",
  Sdg: "bg-amber-600/10 border-amber-600/40 text-amber-800",
  Tdg: "bg-orange-600/10 border-orange-600/40 text-orange-800",
  Swap: "bg-indigo-500/10 border-indigo-500/40 text-indigo-700",
